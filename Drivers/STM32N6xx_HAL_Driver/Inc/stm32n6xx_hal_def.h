...
extern uint32_t __pasram_snoncacheable;
extern uint32_t __pasram_enoncacheable;
#define __PSRAM_NON_CACHEABLE_SECTION_BEGIN ((uint32_t) &__pasram_snoncacheable)
#define __PSRAM_NON_CACHEABLE_SECTION_END   ((uint32_t) &__pasram_enoncacheable)

#endif /* defined(__ICCARM__) */
#define __NON_CACHEABLE __attribute__((section(".noncacheable")))
#define __PSRAM_NON_CACHEABLE __attribute__((section(".psram_bss")))
